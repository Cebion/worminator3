...
// Down
	...
	else if (player.skin == TANK_SKIN && (info_value_1 == tank_solid_info_tile || info_value_2 == tank_solid_info_tile || info_value_3 == tank_solid_info_tile)) player.on_ground = TRUE, player.y_position_in_pixels -= y_amount;
	else if (player.skin == TANK_SKIN && (info_value_1 == tank_solid_from_top_no_drop_info_tile || info_value_2 == tank_solid_from_top_no_drop_info_tile || info_value_3 == tank_solid_from_top_no_drop_info_tile) && (int)player.y_position_in_pixels + 31 == (int)((player.y_position_in_pixels + 31) / 16) * 16) player.on_ground = TRUE, player.y_position_in_pixels -= y_amount;
...
// Up
	...
	else if (player.skin == TANK_SKIN && (info_value_1 == tank_solid_info_tile || info_value_2 == tank_solid_info_tile || info_value_3 == tank_solid_info_tile)) player.y_acceleration = 0, player.y_position_in_pixels -= y_amount;
...
if (touched_info_tile >= switch_1_info_tile && touched_info_tile <= switch_16_info_tile) {
	...
	else if (worminator_map.foreground_tile_grid[x_tile_location][y_tile_location] >= 56 && worminator_map.foreground_tile_grid[x_tile_location][y_tile_location] <= 63) worminator_map.foreground_tile_grid[x_tile_location][y_tile_location] -= 16;
	}
...
if (tile_hit == up_turning_point_info_tile) { player.x_acceleration = 0;  player.y_acceleration = -1; }
if (tile_hit == down_turning_point_info_tile) { player.x_acceleration = 0;  player.y_acceleration = 1; }
if (tile_hit == right_turning_point_info_tile) { player.x_acceleration = 1;  player.y_acceleration = 0; }
if (tile_hit == left_turning_point_info_tile) { player.x_acceleration = -1;  player.y_acceleration = 0; }
if (tile_hit == up_right_turning_point_info_tile) { player.x_acceleration = 1;  player.y_acceleration = -1; }
if (tile_hit == up_left_turning_point_info_tile) { player.x_acceleration = -1;  player.y_acceleration = -1; }
if (tile_hit == down_right_turning_point_info_tile) { player.x_acceleration = 1;  player.y_acceleration = 1; }
if (tile_hit == down_left_turning_point_info_tile) { player.x_acceleration = -1;  player.y_acceleration = 1; }
if (tile_hit == regain_control_info_tile) { player.no_control = FALSE;  return; }
...
if (wormy_config.super_turkey_mode == TRUE) {
	if (player.is_ducking == TRUE) player.frame = SKIN_BAKED_TURKEY_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_BAKED_TURKEY_JUMP;
	...
	else player.frame = SKIN_BAKED_TURKEY_STAND;
	}
	...
	if (player.in_water == FALSE) {
		if (player.is_ducking == TRUE) player.frame = WORMINATOR_DUCK_SET_01 + damage_frame_shift;
		else if (player.on_ground == FALSE) player.frame = WORMINATOR_JUMP_SET_01 + damage_frame_shift;
		else if (player.x_acceleration != 0) {
			if (player.on_ground == TRUE) {
				player.animation_timer++;
				if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_THE_BRAIN_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_THE_BRAIN_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_THE_YIPNIK_MIKIMBO_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_THE_YIPNIK_MIKIMBO_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_HOTDOG_HERO_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_HOTDOG_HERO_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_VOODOO_BADIE_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_VOODOO_BADIE_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_YUANTI_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_YUANTI_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_MELON_O_DEATH_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_MELON_O_DEATH_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_MELON_O_DEATH_STAND;
	}
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_WATERMELON_WONDER_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_WATERMELON_WONDER_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_WATERMELON_WONDER_STAND;
	}
else if (player.skin == THE_INVERTEBRATOR_SKIN) {
	if (player.is_ducking == TRUE) player.frame = SKIN_THE_INVERTEBRATOR_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_THE_INVERTEBRATOR_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_THE_INVERTEBRATOR_STAND;
	}
else if (player.skin == BROWNIE_SKIN) {
	if (player.is_ducking == TRUE) player.frame = SKIN_BROWNIE_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_BROWNIE_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_BROWNIE_STAND;
	}
else if (player.skin == EVIL_CUBE_O_DEATH_SKIN) {
	if (player.is_ducking == TRUE) player.frame = SKIN_EVIL_CUBE_DUCK;
	else {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_ENDO_SKELETON_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_ENDO_SKELETON_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_ENDO_SKELETON_STAND;
	}
else if (player.skin == MUMMY_WORM_SKIN) {
	if (player.is_ducking == TRUE) player.frame = SKIN_MUMMY_WORM_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_MUMMY_WORM_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_MUMMY_WORM_STAND;
	}
else if (player.skin == THE_ANGEL_SKIN) {
	if (player.is_ducking == TRUE) player.frame = SKIN_THE_ANGEL_DUCK;
	else {
		player.animation_timer++;
		if (player.animation_timer == 16) {
	...
	if (player.is_ducking == TRUE) player.frame = SKIN_THE_DEVIL_DUCK;
	else if (player.on_ground == FALSE) player.frame = SKIN_THE_DEVIL_JUMP;
	else if (player.x_acceleration != 0) {
		if (player.on_ground == TRUE) {
			player.animation_timer++;
			if (player.animation_timer == 16) {
	...
	else player.frame = SKIN_THE_DEVIL_STAND;
	}
	...
	else player.frame = SKIN_TANK_WALK_01;
	}
}
...
else if (wormy_config.difficulty == DIFFICULTY_EASY && amount_to_hurt < -2) amount_to_hurt++;
else if (wormy_config.difficulty == DIFFICULTY_HARD && amount_to_hurt <= -1) amount_to_hurt--;
else if (wormy_config.difficulty == DIFFICULTY_NIGHTMARE && amount_to_hurt <= -1) amount_to_hurt -= 2;
