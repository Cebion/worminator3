...
void render_map()
{
	...
	if (worminator_map.weather == 1) {
		for (weather_loop = 0; weather_loop < 64; weather_loop++) putpixel(double_buffer, weather[weather_loop][0], weather[weather_loop][1], 255);
	}
	// Rain
	...
	for (scanner = 0; scanner < number_of_sprites; scanner++) {
		if (sprites[scanner].sprite_active != 0) {
			if (sprites[scanner].sprite_type >= BLUE_SLIME_ENEMY_SPRITE && sprites[scanner].sprite_type <= BOSS_ENEMY_SPRITE && sprites[scanner].hit_points_left != -666) {
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(255, 0, 0));
				...
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(0, 255, 0));
				...
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(255, 255, 255));  putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16) + 1, (sprites[scanner].y_position_in_pixels / 16), makecol(255, 255, 255));
			} else if (sprites[scanner].sprite_type == RED_DOOR_SPRITE && sprites[scanner].action_state == 0) {
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(255, 0, 0));  putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16) + 1, makecol(255, 0, 0));
			} else if (sprites[scanner].sprite_type == GREEN_DOOR_SPRITE && sprites[scanner].action_state == 0) {
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(0, 255, 0));  putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16) + 1, makecol(0, 255, 0));
			} else if (sprites[scanner].sprite_type == BLUE_DOOR_SPRITE && sprites[scanner].action_state == 0) {
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(0, 0, 255));  putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16) + 1, makecol(0, 0, 255));
				...
				putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16), makecol(255, 255, 0));  putpixel(double_buffer, (sprites[scanner].x_position_in_pixels / 16), (sprites[scanner].y_position_in_pixels / 16) + 1, makecol(255, 255, 0));
			}
		}
	}
